...
export default function Checkout() {
  ...
  return (
    <>
        ...
        <div className="max-w-screen-2xl mx-auto h-full px-3 relative z-10">
          <div className="flex lg:flex-col flex-col lg:gap-9 md:gap-5 gap-3 w-full h-full justify-center items-center">
            ...
            <ul className="flex items-center justify-center w-full gap-2">
              ...
              <li className="text-white text-lg font-normal">Checkout</li>
            </ul>
          </div>
        </div>
      ...
      <section className="overflow-hidden CheckoutBg relative bg-contain bg-no-repeat bg-center lg:pt-20 md:pt-20 pt-12 lg:pb-20 md:pb-20 pb-12">
        <div className="max-w-screen-2xl relative z-10 mx-auto h-full px-3">
          <div className="flex lg:flex-row md:flex-col flex-col lg:gap-20 md:gap-10 gap-10 w-full h-full justify-start">
            <div className="w-full lg:basis-1/3 basis-full flex items-start justify-center flex-col">
              <div className="bg-white shadow-lg rounded-xl">
                <div className="p-5 h-full lg:max-h-full md:max-h-full max-h-[90vh] overflow-auto">
                  <h1 className="lg:text-xl mb-4 md:text-xl text-xl text-dark font-medium leading-tight flex items-center gap-4">
                    <Icon icon="solar:user-bold" className="text-[#2a2d6d]" />
                    Contact Detail
                  </h1>
                  <div className="w-full border focus:border-[#000] transition-all duration-700 hover:border-[#000] rounded-full p-2 flex items-center gap-3">
                    <input
                      type="text"
                      placeholder="your emil id"
                      className="border-0 outline-none shadow-none w-full bg-transparent text-[#000] placeholder:text-[#000] text-[16px] font-normal  lg:h-[35px] md:h-[35px] h-[35px] ps-5"
                    />
                  </div>
                  <div className="w-full mt-5 border-t pt-5">
                    <h1 className="lg:text-xl mb-4 md:text-xl text-xl text-dark font-medium leading-tight flex items-center gap-4">
                      <Icon
                        ...
                        className="text-[#2a2d6d]"
                      />
                      Shipping Detail
                    </h1>
                    <div className="flex items-center lg:flex-row md:flex-row flex-col gap-4 mt-4">
                      <div className="w-full border lg:basis-1/2 md:basis-1/2 basis-full focus:border-[#000] transition-all duration-700 hover:border-[#000] rounded-full p-2 flex items-center gap-3 mt-0">
                        <input
                          type="text"
                    ...
                    <div className="flex items-center lg:flex-row md:flex-row flex-col gap-4 mt-4">
                      <div className="w-full border basis-full focus:border-[#000] transition-all duration-700 hover:border-[#000] rounded-full p-2 flex items-center gap-3 mt-0">
                        <input
                          type="text"
                          placeholder="Address"
                          className="border-0 outline-none shadow-none w-full bg-transparent text-[#000] placeholder:text-[#000] text-[16px] font-normal  lg:h-[35px] md:h-[35px] h-[35px] ps-5"
                    ...
                    <div className="w-full flex lg:flex-row md:flex-row flex-col lg:items-center md:items-center items-start gap-5 border-b-0 p-2 px-0">
                      <div className="flex items-center gap-3">
                        <div className="w-[80px] h-[80px] rounded-3xl overflow-hidden p-3 bg-[#c3c3c34d]">
                          <Image
                            src={passion}
                            alt="Site Logo"
                      ...
                      <div className="w-full">
                        <h5 className="text-md text-[#000] m-0 font-medium">
                    ...
                    <div className="mt-5 border-t pt-5">
                      <h1 className="lg:text-xl mb-4 md:text-xl text-xl text-dark font-medium leading-tight flex items-center gap-4">
                        <Icon icon="tdesign:money" className="text-[#2a2d6d]" />
                        Cart Tottal
                      </h1>
                      {/* <hr className="my-4" /> */}
                      ...
                      <div className="flex items-center mt-4 gap-4 justify-between">
                        <h6 className="text-base font-normal">Tax</h6>
                        <h6 className="text-base font-normal">$0.00</h6>
                      </div>
            ...
            <div className="w-full lg:basis-2/3 basis-full flex items-center justify-center flex-col">
              {/* <div className="w-full h-full lg:p-5 p-0 lg:border-s-2 rounded-sm">
                                        <h5 className="text-2xl text-[#000] m-0 font-medium">Cart Tottal</h5>
                                        <hr className="my-4" />
                                        ...
                                        <div className="mt-10">
                                             <button
                                                  className="border-0 w-full flex items-center gap-[10px] font-normal px-10 py-4 text-[16px] text-white bg-[#2A2D6D] hover:bg-[#2A2D6D] transition duration-700 ease-in-out rounded-[8px] justify-center  hover:-translate-y-2">
                                                  Submit
                                             </button>
                                        </div>
                                   </div> */}
