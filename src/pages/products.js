...
import ProductImgs from "./crousel/productCarousel";
...
export default function products() {
  ...
  return (
    <>
      ...
      <section className="bg-[url('../../public/productBg.png')] after:absolute after:top-0 after:left-0 after:right-0 after:bg-[url('../../public/Tile-Passion-Illustration.png')] after:bg-c after:bg-no-repeat after:bg-center after:opacity-50 after:w-full after:h-full overflow-hidden relative xl:h-[100vh] min-h-screen bg-cover bg-bottom lg:pt-40 md:pt-40 pt-32 pb-20 productBg">
        <div className="max-w-screen-2xl relative z-10 mx-auto h-full px-3 rounded-none">
          <div className="flex lg:flex-row flex-col gap-4 w-full g-3 h-full">
            <div className="w-full lg:basis-1/4 pt-10 basis-full flex items-start justify-start flex-col">
              <div className="w-full">
                <h1 className="xl:text-6xl lg:text-4xl text-white font-medium leading-tight">
                  passion energy infusion
                </h1>

                <h2 className="xl:text-2xl mt-5 text-white font-medium leading-tight">
                  300ml
                </h2>
              </div>
            </div>
            ...
            <div className="w-full lg:basis-1/2 basis-full flex items-center justify-center flex-col">
              <div className="w-full flex flex-col gap-8 items-center justify-between">
                ...
                <h1 className="xl:text-5xl lg:text-4xl text-white font-medium leading-tight">
                  $25.50
                </h1>
              </div>
            </div>

            <div className="w-full lg:basis-1/4 basis-full pt-10 flex items-end justify-between flex-col">
              <div className="flex items-center gap-2">
                <div className="w-[50px] h-[50px] rounded-full bg-[#4d5647b3] flex items-center justify-center text-[12px] text-white font-normal hover:bg-white hover:text-[#000] cursor-pointer">
                  50ml
                </div>
                <div className="w-[50px] h-[50px] rounded-full bg-[#fff] flex items-center justify-center text-[12px] text-dark font-normal cursor-pointer">
                  60ml
                </div>
                <div className="w-[50px] h-[50px] rounded-full bg-[#4d5647b3] flex items-center justify-center text-[12px] text-white font-normal hover:bg-white hover:text-[#000] cursor-pointer">
                  100ml
              ...
              <div className="flex items-center w-full justify-between gap-4">
                <div className="flex items-center justify-between gap-4">
                  ...
                  <input
                    type="text"
                    className="bg-transparent outline-none border-0 text-[18px] placeholder:text-[18px] text-white w-[30px] text-center placeholder:font-bold"
                    value={1}
                  />
                ...
                <button className="border-0 text-[15px] px-6 py-4 text-[#000] font-bold bg-[#ffffff80] hover:bg-[#fff] transition duration-700 ease-in-out rounded-full  hover:-translate-y-2">
                  Buy Now
                </button>
              </div>
            </div>
      ...
      <Footer />
      {/* <footer className="pt-16 pb-28 relative bg-white border-t-0 border-[#BABABA]">
                    <div className="max-w-screen-2xl  mx-auto px-3">
