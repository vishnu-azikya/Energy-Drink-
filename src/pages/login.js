          ...
          <div className="flex lg:flex-row flex-col lg:gap-20 md:gap-16 gap-10 w-full h-full justify-start">
            <div className="w-full lg:basis-1/2 basis-full flex items-start justify-center flex-col">
              ...
              <div className="lg:pt-10 md:pt-10 pt-0 w-full space-y-5 lg:max-w-[450px]">
                ...
                <div className="flex items-center justify-between pt-0 lg:px-5">
                  {/* <div className="flex items-center gap-2">
                    <div className="checkboxUI">
                      <div className="border-2  border-[#000] rounded-full w-[30px] h-[30px] relative">
                        <input type="checkbox" className="w-[25px] h-[25px] absolute opacity-0 border-2 border-[#000] bg-[#000] rounded-[15px] z-10" />
                        <span className="w-[30px] h-[30px] absolute -top-[2px] -left-[2px] flex items-center justify-center rounded-full">
                          <svg viewBox="0 0 24 24" className="w-[20px] h-[20px]" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M4 12.6111L8.92308 17.5L20 6.5" stroke="#fff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
                        </span>
                      </div>
                    </div>
                    <p className="text-[16px] font-normal m-0 text-[#000]">Remember Me</p>
                  </div> */}
                  <a href="#" className="text-[16px] text-[#2A2D6D]">
                    Forgot Password
                  </a>
                </div>
            ...
            <div className="w-full lg:basis-1/2 basis-full flex items-center justify-center flex-col">
              <div className="w-full h-full  flex items-center justify-center bg-[#2a2d6d33] rounded-3xl">
                <Image
                  src={loginImg}
                  alt="Site Logo"
          ...
          <div className="flex items-center gap-3 justify-between">
            ...
            <ul className="flex itmes-center gap-1">
              ...
              <li>
                <a href="#">
                  <svg width="30" height="30" viewBox="0 0 30 30" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M19.6902 8.1344C19.0171 7.29394 18.6125 6.19805 18.6125 5H17.7691M19.6902 8.1344C20.3036 8.90063 21.1342 9.45788 22.0799 9.67608C22.3738 9.74574 22.6805 9.78293 23 9.78293V13.2191C21.3643 13.2191 19.8477 12.648 18.6123 11.6821V18.6707C18.6123 22.1627 16.0053 25 12.8062 25C11.1321 25 9.6198 24.2198 8.5591 22.98C7.59212 21.847 7 20.3331 7 18.6707C7 15.2298 9.53036 12.4251 12.6656 12.3508M19.6902 8.1344C19.6739 8.12276 19.6575 8.11101 19.6413 8.09914M10.6593 20.3517C10.3441 19.8781 10.1566 19.2977 10.1566 18.6661C10.1566 17.0734 11.3451 15.7778 12.8063 15.7778C13.0789 15.7778 13.343 15.8288 13.5901 15.9124V12.4019C13.3345 12.3647 13.0746 12.3415 12.8063 12.3415C12.7594 12.3415 12.3819 12.3688 12.3351 12.3688M17.7646 5H15.4558L15.4516 18.7775C15.4004 20.3192 14.2332 21.5591 12.8062 21.5591C11.9201 21.5591 11.1406 21.0808 10.655 20.3564" stroke="black" stroke-linejoin="round" />
                  </svg>
                </a>
              </li>
            </ul>
